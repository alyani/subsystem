...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // User manage balance
        Route::prefix('user/manageBalance')->controller(UserManageBalanceController::class)->group(function () {
        ...
        // Faq category
        Route::prefix('faqCategory')->controller(FaqCategoryController::class)->group(function () {
        ...
        // Article category
        Route::prefix('articleCategory')->controller(ArticleCategoryController::class)->group(function () {
        ...
        // Heavy uploader
        Route::prefix('heavy')->controller(HeavyUploaderController::class)->group(function () {
