...
@section('content')
    <div class="card">
        <div class="card-body">
            {!! html()->form('POST', route('admin.faq.store'))->open() !!}

            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        {{ html()->label(st('Question') . ' *', 'question')->class('control-label') }}
                        {{ html()->textarea('question', old('question'))->class('form-control')->rows(2)->placeholder(st('Enter the question')) }}
                    </div>
                </div>

                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        <x-subsystem::tiny-mce name="answer" label="{{ st('Answer') }} *" value="{{ old('answer') }}"/>
                    </div>
                </div>
                ...
                @if(!request('categoryID'))
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            {{ html()->select('categoryID', $faqCategories ?? [])->class('form-control')->placeholder(st('Select category'))->value(old('categoryID')) }}
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->text('meta_title', old('meta_title'))->class('form-control')->placeholder(st('Meta Title')) }}
                    </div>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->textarea('meta_description', old('meta_description'))->class('form-control')->rows(3)->placeholder(st('Meta Description')) }}
                    </div>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        ...
                        {{ html()->text('meta_keyword', old('meta_keyword'))->class('form-control')->placeholder(st('Meta Keyword')) }}
                    </div>
                </div>
            </div>
        </div>
